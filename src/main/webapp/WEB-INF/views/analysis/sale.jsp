...
$(function(){
	...
	<c:forEach var="adto" items="${alist}">
		var label = "${adto.month}"
		var month_price = ${adto.price}
	...
	var myLineChart = new Chart(ctx1, {
	  ...
	  data: {
	    ...
	    datasets: [{
	      ...
	      pointHitRadius: 10,
	      pointBorderWidth: 2,
	      data: [${price1}*1000,${price2}*1000,${price3}*1000,${price4}*1000],
	    }],
	  },
	  options: {
		    maintainAspectRatio: false,
	  ...
	  options: {
		...
		$("#prod_cate1").change(function(){
			$("#prod_cate1 option:selected").each(function(){ 
		       var p = $(this).val();
		      	location="sale?year=${year}&month=${month}&day=${day}&menu=${menu}&cate1="+p+"#card_body"
		});
		});
		$("#prod_cate2").change(function(){
			$("#prod_cate2 option:selected").each(function(){
		       ...
		       var p2 = $(this).val();
		      	location="sale?year=${year}&month=${month}&day=${day}&menu=${menu}&cate1="+p+"&cate2="+p2+"#card_body"
		});
		});
		$("#prod_cate3").change(function(){
			$("#prod_cate3 option:selected").each(function(){
				...
				var p2 = $("#prod_cate2").val();
		      	var p3 = $(this).val();
		      	location="sale?year=${year}&month=${month}&day=${day}&menu=${menu}&cate1="+p+"&cate2="+p2+"&cate3="+p3+"#card_body"
		});
		});
});
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <form method="post" action="sale?menu=6">
                                ...
                                <div class="card-body" id="card_body">
	                                ...
	                                <div style="text-align:center; padding-left:5px">
										<c:if test="${pagestart != 1}">
											<a href="sale?year=${year}&month=${month}&day=${day}&menu=${menu}&cate1=${cate1}&cate2=${cate2}&cate3=${cate3}&page=${pagestart-1}#card_body"> << </a>
										</c:if>
										<c:if test="${page != 1}">
											<a href="sale?year=${year}&month=${month}&day=${day}&menu=${menu}&cate1=${cate1}&cate2=${cate2}&cate3=${cate3}&page=${page-1}#card_body"> < </a>
										</c:if>
										<c:forEach var="i" begin="${pagestart}" end="${pageend}">
											...
											<c:if test="${page != i}">
												<a href="sale?year=${year}&month=${month}&day=${day}&menu=${menu}&cate1=${cate1}&cate2=${cate2}&cate3=${cate3}&page=${i}#card_body">${i}</a>
											</c:if>
										</c:forEach>
										...
										<c:if test="${page != pagecnt}">
											<a href="sale?year=${year}&month=${month}&day=${day}&menu=${menu}&cate1=${cate1}&cate2=${cate2}&cate3=${cate3}&page=${pageend +1}#card_body"> >></a>
										</c:if>
									</div>
                                </div>
                			</div>
                        ...
                        <div class="col-lg-6 mb-4">
                            <!-- Project Card Example -->
                            <form method="post" action="sale?menu=3">
           					<div class="card shadow mb-4"style="display:inline-block; left:24px; width:952px" >
                                <div class="card-header py-3" >
                                	<h6 class="m-0 font-weight-bold text-primary" style="display:inline-block">연도 선택</h6>
                                	<div style="display:inline-block">
                			...
                			<div class="card shadow mb-4"style="display:inline-block; left:11px; width:952px" >
                                <div class="card-header py-3" >
                                    <div style="display:inline-block"><h6 class="m-0 font-weight-bold text-primary">3분기 판매 worst</h6></div><div style="display:inline-block;float:right" id="angle6"><i class="fas fa-angle-down" id="angle_i6"></i></div>
                                </div>
           				...
           				<c:if test="${menu == 'm'}">
           				<form method="post" action="sale?menu=m">
           				<div class="card shadow mb-4"style="display:inline-block; left:24px; width:952px" >
                                <div class="card-header py-3" >
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4"style="display:inline-block; left:11px; width:952px" >
                                ...
                                <div class="card-body" id="card_body">
	                                ...
	                                <div style="text-align:center; padding-left:5px">
										<c:if test="${pagestart != 1}">
											<a href="sale?year=${year}&month=${month}&day=${day}&menu=${menu}&cate1=${cate1}&cate2=${cate2}&page=${pagestart-1}#card_body"> << </a>
										</c:if>
										<c:if test="${page != 1}">
											<a href="sale?year=${year}&month=${month}&day=${day}&menu=${menu}&cate1=${cate1}&cate2=${cate2}&page=${page-1}#card_body"> < </a>
										</c:if>
										<c:forEach var="i" begin="${pagestart}" end="${pageend}">
											<c:if test="${page == i}">
												<span style="color:red">${i}</span>
											...
											<c:if test="${page != i}">
												<a href="sale?year=${year}&month=${month}&day=${day}&menu=${menu}&cate1=${cate1}&cate2=${cate2}&page=${i}#card_body">${i}</a>
											</c:if>
										</c:forEach>
										<c:if test="${page != pagecnt}">
											<a href="sale?year=${year}&month=${month}&day=${day}&menu=${menu}&cate1=${cate1}&cate2=${cate2}&page=${page+1}#card_body"> > </a>
										...
										<c:if test="${page != pagecnt}">
											<a href="sale?year=${year}&month=${month}&day=${day}&menu=${menu}&cate1=${cate1}&cate2=${cate2}&page=${pageend +1}#card_body"> >></a>
										</c:if>
									</div>
                                </div>
                			</div>
           				...
           				<c:if test="${menu == 'w'}">
           				<form method="post" action="sale?menu=w">
           				<div class="card shadow mb-4"style="display:inline-block; left:24px; width:952px" >
                                <div class="card-header py-3" >
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4"style="display:inline-block; left:11px; width:952px" >
                                <div class="card-header py-3" >
                                    <div style="display:inline-block"> <h6 class="m-0 font-weight-bold text-primary">주간 판매 best</h6></div><div style="display:inline-block;float:right" id="angle1"><i class="fas fa-angle-down" id="angle_i1"></i></div>
                                </div>
                                <div class="card-body" id="angle_body1">
	                                <div style="height:30px">
	                                    <div class="table1" style="width:100px"><h4 class="small font-weight-bold">제품사진</h4></div>
                			...
                			<div class="card shadow mb-4"style="display:inline-block; left:11px; width:952px" >
                                <div class="card-header py-3" >
                                    <div style="display:inline-block"> <h6 class="m-0 font-weight-bold text-primary">주간 판매 worst</h6></div><div style="display:inline-block;float:right" id="angle2"><i class="fas fa-angle-down" id="angle_i2"></i></div>
                                </div>
                                <div class="card-body" id="angle_body2">
	                                <div style="height:30px">
	                                    <div class="table1" style="width:100px"><h4 class="small font-weight-bold">제품사진</h4></div>
                                ...
                                <div class="card-body">
	                                 <table class="my_reserve" height="50px" align="center">
										<tr height="60px" style="border-bottom:2px solid navy;">
											<td>
												<c:if test="${month == 1}">
													<a href="sale?menu=d&year=${year-1}&month=${month}&day=1"> ◀ </a>
												</c:if>
												<c:if test="${month != 1}">
													<a href="sale?menu=d&year=${year}&month=${month-1}&day=1"> ◀ </a>
												</c:if>
												</td>
												<td colspan="5" align="center">${month}월</td>
												<td>
												<c:if test="${month == 12}">
													<a href="sale?menu=d&year=${year+1}&month=1&day=1"> ◀  </a>
												</c:if>
												<c:if test="${month != 12}">
													<a href="sale?menu=d&year=${year}&month=${month+1}&day=1"> ▶  </a>
												</c:if>
										...
										<c:forEach var="i" begin="0" end="${week-1}">
											<tr>
												<c:forEach var="j" begin="0" end="6">
													...
													<c:if test="${!((firstdate > j && i == 0) || (total_days < day))}">
														 <td><a href="sale?menu=d&year=${year}&month=${month}&day=${d}">${d}</a></td>

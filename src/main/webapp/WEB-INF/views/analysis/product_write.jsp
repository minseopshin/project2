                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4"style="display:inline-block; left:11px; width:952px" >
                                ...
                                function move(h)
                                {
                                   location="product_write?category1="+h;	
                                   
                                }
                                </script>
                                <div class="card-body">
	                                <div>
	                                  <form method="post" action="product_write_ok" enctype="multipart/form-data">
	                                    ...
	                                    <div style="display:inline-block"><h4 class="small font-weight-bold">제품명</h4> <input type="text" name="prd_name"></div> <p>
	                                    <div style="display:inline-block"><h4 class="small font-weight-bold">가　격</h4> <input type="text" name="price"></div> <p>																				
	                                    <div style="display:inline-block"><h4 class="small font-weight-bold">이미지</h4> <input type="file" name="prd_img"></div> <p>
	                                    <div style="display:inline-block"><h4 class="small font-weight-bold">상　세</h4> <input type="file" name="detail_img"></div> <p>
	                                  ...
	                                  <form method="post" action="product">
	                                    <div style="display:inline-block"><input type="submit" value="목록"></div>
	                                  </form>
	                                </div>

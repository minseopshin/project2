...
<hr>
			...
			<ul class="tab1_1" style="list-style-type:none;">
				...
				<li><a href="membershipinfo">1:1문의</a></li>
				<li><a href="membershipinfo" class="active">멤버쉽혜택</a></li>
...
<img src="resources/img/eventinfo.png" border=0  style="width:1000px;height:1600px;padding-left:300px;">
</div>

...
<div id="container">
		...
		<div class="contents join">
			<h2>비밀번호 확인</h2>
			 ...
			 <!--20191014 회원가입 문구 추가-->
			<p class="txt-h2">보안을 위해 비밀번호를 변경해주시기 바랍니다.</p>
                    <!--//20191014 회원가입 문구 추가-->
 ...
 <c:if test="${pwd != null}">
   <strong> * 당신의 비밀번호는 ${pwd}입니다.</strong>
   </c:if>
   <c:if test="${pwd == null}">
...
<p>
   ...
   <p>
         ...
         <p>
        <tr align="center">
        <td colspan="6"><a href="main"> <input type="button"  class="submit_form" value="이전으로"></a> ⊙ 메인페이지로 돌아갑니다.</td>
      </tr>

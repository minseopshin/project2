...
.submit_form
{
 ...
 <script>
  ...
  <form name="pkc" method="post"  action="userid_ok" onsubmit="return check()">
	...
	<div id="container">
		...
		<div class="contents join">
			...
			<div>
      <tr align="center">
        <td colspan="2"> <input type="submit" class="submit_form" value="아이디확인"> ※회원정보를 정확히 확인해주시기 바랍니다.</td>
      </tr>
      <p>
        <tr align="center">
        <td colspan="6">  <a href="findpwd"> <input type="button"  class="submit_form" value="비밀번호찾기"></a> ※계정확인 후 비밀번호 찾기 페이지로 넘어갑니다.</td>
      </tr>

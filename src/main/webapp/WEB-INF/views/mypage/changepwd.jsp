...
<hr>
			...
			<ul class="tab1_1" style="list-style-type:none;">
				...
				<li><a href="changepwd" class="active">비밀번호변경</a></li>
				...
				<li><a href="/member/destination_ma
				nage.asp">배송지 관리</a></li>
			</ul>

		 <form name="pkc" method="post" action="changepwd_ok" onsubmit="return check()">
				...
				<table class="tbl-y view">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<input type="password" class="text_form" name="pwd" value="${mdto.pwd}" />
					...
					<tr>
						...
						<a href="changepwd2"><input type="button" class="submit_form" onclick="return pwd2_check()" value="일치확인"> </a>
						</td>
					</tr>
		...
		<!--  	<tr>
							...
							<td>
								<input type="password" class="text_form" placeholder="비밀번호 입력" name="pwd" value="${pwd}" />
						 ...
						 <tr id="trpwd1">
							<th>비밀번호 변경</th>
							<td>
								<input type="password" class="text_form" placeholder="변경할 비밀번호 입력" name="pwd" value="${pwd}" />
...
<!-- 혼자
<tr>
						<th><strong class="p-red">* </strong>  변경할 비밀번호</th>
						<td>

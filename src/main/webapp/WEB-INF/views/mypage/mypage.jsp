...
<div id="container">
		...
		<div class="contents my">
				...
				<div class="topBanner">
						...
						<ul id="cycle" class="cycle-slideshow" style="list-style-type:none;">
						

						<li>
							<a href="javascript:;" onclick="go_banner_log('3073');"><img src="https://data.0app0.com/diet/banner/3073_1623683295.jpg" /></a>
						</li>
						
						</ul>
						<div class="page-topBanner"></div>
...
<hr>
			...
			<h2 class="bdbnone">마이페이지</h2>


			<ul class="tab1_1" style="list-style-type:none;">
				<li><a href="mypage" class="active">회원정보</a></li>
				<li><a href="changepwd">비밀번호변경</a></li>
		 ...
		 <form name="pkc" method="post" action="mypage_ok">
			...
			<div class="tbl-y-wrap r5">
				<table class="tbl-y view">
					...
					<tbody>
						<tr>
							<th>아이디</th>
							<td class="lh30">${userid}</td>
						</tr>
						<tr>
							<th>* 이메일 계정</th>
		<td>
								<input type="text" class="text_form" name="email" value="${mdto.email}" >
							</td>
						</tr>
						<tr>
							<th>* 이름</th>
							<td>
								<input type="text" class="text_form" name="name" value="${name} " >
							</td>
							...
							<th>* 전화번호</th>
							<td>
								<input type="text" class="text_form" name="phone" value="${mdto.phone} " >
							</td>
							...
							<th>* 주소</th>
							<td>
								<input type="text" class="text_form" name="address" value="${mdto.address} " >
							</td>
						</tr>
<!-- 
						<tr>
							...
							<td>
								<input type="password" class="text_form" placeholder="비밀번호 입력" name="pwd" value="${mdto.pwd}" />
						...
						<!-- 
						 <tr id="trpwd1">
							<th>비밀번호 변경</th>
							<td>
								<input type="password" class="text_form" placeholder="변경할 비밀번호 입력" id="new_pwd" />
								<div class="join_pw_tip"><strong>영문/숫자/특수문자(공백제외) 중 2개 이상 조합</strong><em>(10자 이상 입력, 동일한 숫자 3개 이상 연속 사용 불가)</em></div>
							</td>
						</tr>
						<tr id="trpwd2" style="display:none">
							<th>비밀번호 확인</th>
							<td>
								<input type="password" class="text_form" placeholder="비밀번호 확인" id="new_pwd_ok" />
							</td>
						</tr>-->
						...
						<tr>
							<th style="vertical-align:top">마케팅 수신동의</th>
							<td class="num_l">
							<div class="agreement_wrap mr30">
							  <p class="fc333 fs13">다양한 이벤트, 각종 할인/상품정보에 대한 안내를 받겠습니다. </p>
							  <p class="agrees_ws mt10 ml-4">
								  <span class="agrees">
										<input type="checkbox" id="c2" name="cc"  checked/><label for="c2"><span></span><em class="agree_txt">이메일 수신동의</em></label>
								  </span>
								  <span class="agrees">
										<input type="checkbox" id="c3" name="cc" checked/><label for="c3"><span></span><em class="agree_txt">문자 수신동의</em></label>
								  </span>
							  </p>
							  <p class="agrees_tip mt10">단, 휴대폰번호와 이메일이 등록된 경우에만 발송되며, 거래정보 관련 내용은 동의여부와 무관하게 발송됩니다. </p>
								</div>
							  ...
							  <table class="tbl_mem_noti" summary="회원가입" >
								 ...
								 <tbody>
									...
									<tr>
									    <td class="mem_info_noti_td">각종 이벤트, 행사 관련<br>정보안내 및 마케팅</td>
									    <td class="mem_info_noti_td">이메일, 휴대폰번호,<br> 서비스 이용기록</td>
									    <td class="mem_info_noti_td">회원탈퇴 시 또는<br>법정 의무 보유 기간</td>
									</tr>
								 </tbody>
							  </table>
						   </div>
			...
			<div class="btn_m_out">
            	<a href="member_out" class="off">회원탈퇴</a>
            </div>

			        <tr align="center">
        <td colspan="6">  <input type="submit"  class="submit_form" value="변경하기"> ※ 회원정보 수정 후 메인페이지로 돌아갑니다.</td>
      </tr>
		</div><!-- // contents -->
</form>
</div>
